/**
 * Ceviri sozlugu - yalnizca build zamaninda kullanilir.
 *
 * Bu dosya yayinlanan siteye dahil edilmez (_config.yml -> exclude). Metinler
 * `scripts/build-en.mjs` tarafindan index.html'e gomulerek en/index.html
 * uretilir, dolayisiyla tarayiciya hicbir ceviri verisi gonderilmez.
 */

/** Sayfa basi head metadata'si. */
export const pageMeta = {
  tr: {
    lang: "tr",
    canonical: "https://emrebulut.tech/",
    ogLocale: "tr_TR",
    ogLocaleAlternate: "en_US",
    title: "Emre Bulut | Elektrik-Elektronik Mühendisliği Öğrencisi",
    description:
      "Emre Bulut - Elektrik ve Elektronik Mühendisliği öğrencisi. Bilgisayarlı görü, gömülü sistemler ve enerji sistemleri üzerine projeler.",
    ogDescription:
      "Bilgisayarlı görü, gömülü sistemler ve enerji sistemleri üzerine projeler geliştiren EEE öğrencisi.",
    langNavLabel: "Dil seçimi",
    skipToContent: "İçeriğe geç"
  },
  en: {
    lang: "en",
    canonical: "https://emrebulut.tech/en/",
    ogLocale: "en_US",
    ogLocaleAlternate: "tr_TR",
    title: "Emre Bulut | Electrical & Electronics Engineering Student",
    description:
      "Emre Bulut - Electrical and Electronics Engineering student. Projects across computer vision, embedded systems, and energy systems.",
    ogDescription:
      "Electrical and electronics engineering student building projects across computer vision, embedded systems, and energy systems.",
...
/**
 * Ceviri anahtarlari olmayan ama dile gore degismesi gereken serbest metinler.
 * Bunlar isaretlemede data-i18n tasimayan dugumler icin birebir eslesme yapar.
 */
export const literalReplacements = {
  en: {
    "İstanbul, Türkiye": "Istanbul, Türkiye",
    "İstanbul Medipol Üni.": "Istanbul Medipol Univ.",
    "İstanbul Medipol Üniversitesi": "Istanbul Medipol University",
    "Tahmini Mezuniyet: Haziran 2028": "Expected Graduation: June 2028",
    "Eylül 2025 — Temmuz 2026": "September 2025 — July 2026"
  }
};
...
export const translations = {
  tr: {
    ...
    "projects.autonomous.solar.desc":
    ...
    "projects.roomgate.desc":
      "Bilgisayarlı görüyü donanım kontrolüyle birleştiren yapay zeka destekli bir güvenlik prototipi. Uç (edge) cihazlar için optimize edilmiş bir YOLO26 nesne tespit modelini röle tabanlı bir kilit sistemine entegre ettim.",
    "projects.roomgate.problem":
    ...
    "projects.roomgate.approach":
      "Uç (edge) cihazlarda çalışacak şekilde optimize edilmiş bir YOLO26 nesne tespit modeli geliştirip, röle tabanlı bir kilit mekanizmasına entegre ettim.",
    "projects.roomgate.result":
    ...
    "contact.intro":
      "Bir proje, staj fırsatı ya da sadece mühendislik üzerine sohbet etmek için bana ulaşabilirsin.",
    "contact.cvBtn": "CV ↓",
  ...
  en: {
    ...
    "contact.intro":
      "Feel free to reach out for a project, internship opportunity, or just to chat about engineering.",
    "contact.cvBtn": "CV ↓",
